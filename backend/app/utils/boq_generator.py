...
from app.db.models import TakeoffItem, Rate, FederatedQuantity
...
class BOQGenerator:
    ...
    async def _get_items(self) -> List[BOQItem]:
        ...
        for item in fed_items:
            unified.append(BOQItem(
                ...
                quantity=float(item.quantity_value),
    ...
    async def _get_rates(self) -> List[Rate]:
        ...
        # Order by project_id DESC so project-specific rates (non-null) come first
